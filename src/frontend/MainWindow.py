...
button_api_file = Button(root,
                         text="Select API file",
                         fg="red",
                         command=select_api_file)
button_save_api = Button(root,
                         text="Save your API to file",
                         fg="red",
                         command=save_file)
button_files_to_scan = Button(root,
